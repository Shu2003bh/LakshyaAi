...
export default function CareerTestForm() {
    ...
    return (
        ...
        <div className="max-w-xl mx-auto space-y-6">
            ...
            {selectedCareer && (<RoadmapView career={selectedCareer} />
            )}
            ...
            {careers.length > 0 && !selectedCareer && (
                ...
                <div className="space-y-4">
                    ...
                    {careers.map((c, i) => (
                        ...
                        <Card
                            key={i}
                            className="cursor-pointer border hover:border-indigo-500 hover:shadow-md transition"
                                ...
                                <Button
                                    ...
                                    className={`w-full justify-start rounded-lg border 
                                             border-gray-300 bg-white text-gray-800 
                                                     hover:bg-indigo-200 hover:border-indigo-600
                                         ${answers[step] === opt ? "bg-indigo-300 border-indigo-500 text-indigo-700" : ""}
  `}
